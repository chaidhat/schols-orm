...
export function isTokenPrimitive(token) {
...
export function assertType(propertyName, input, shouldBeType) {
...
export function sanitizeSqlValue(input) {
...
export function readBool(input) {
